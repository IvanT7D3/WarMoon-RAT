...
void HelpMenu()
{
	...
	printf("\n");
	printf("\033[1;31mThe following function is used to inject shellcode and obtain a reverse shell. [!]Set the listener first\033[0m\n");
	printf("\033[0;33m inject86 : \033[1;31m(x64) Injects shellcode into Notepad. [!]Set msfconsole first.\033[0m\n");
	printf("\n");
